...
Layer5 does not knowingly collect, either online or offline, personal information from persons under the age of thirteen. If you are under 18, you may use https://cloud.layer5.io/ only with permission of a parent or guardian.
          </Col>
        </Row>
        <Row>
          <Col $xs={12} $sm={12} $lg={12}>
        ...
        <Row>
          <Col $xs={12} $sm={12} $lg={12}>
            ...
            <p>
              The Service is controlled, operated and administered by Layer5 from our offices within the USA. If you access the Service from a location outside the USA, you are responsible for compliance with all local laws. You agree that you will not use the Layer5 Content accessed through https://cloud.layer5.io/ in any country or in any manner prohibited by any applicable laws, restrictions or regulations.
            </p>
          </Col>
        </Row>
        <Row>
